...
def main():
    ...
    # input_wav = "prototype.wav"
    # input_wav = "bare.wav"
    input_wav = "electret.wav"
    # input_wav = "anechoic1.wav"
    # input_wav = "anechoic2.wav"
    # input_wav = "auscultawear_evening.wav"
    # input_wav = "stemoscope_2k.wav"

    data, samplerate, time = wav_to_array(input_wav)
    filtered_input = bandpass_filter(data, samplerate)
    denoised_coefficients = denoising(filtered_input, wavelet)
    ...
    # print(f'Size: {samplerate*time}   Coeff5: {len(coeff5)}   L5_wave: {level5_wave.size}')
    ...
    # """
    # print(f'Data Size: {data.size}   Time Size: {time.size}')
    
    print(f'Runtime: {t.process_time() - start :.4f}s')
